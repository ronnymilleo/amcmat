...
for i = 1:length(snrVector)
    ...
    for j = 1:frames
        qam16_signal(i,j,:) = QAM(16,frameSize,symbolRate,numSamplesPerSymbol,snrVector(i),modParameters);
        qam64_signal(i,j,:) = QAM(64,frameSize,symbolRate,numSamplesPerSymbol,snrVector(i),modParameters);
        qam256_signal(i,j,:) = QAM(256,frameSize,symbolRate,numSamplesPerSymbol,snrVector(i),modParameters);
    end
end
end